...
class CreateMessageRequestDto extends AbstractDto
{
    ...
    /**
     * Set the "target" field. The target of the message. For USER_BY_PROVIDER_ID target type, use numeric provider IDs. For other target types, use appropriate string identifiers (UUIDs)
     *
     * @return static
     */
